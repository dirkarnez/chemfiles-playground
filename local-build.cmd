...
cmake.exe -G"MinGW Makefiles" -DCHEMFILES_ROOT="D:/Code Projects/cpp-libraries/chemfiles-v0.10.2-x86_64-posix-seh-rev0-8.1.0" -DCMAKE_BUILD_TYPE=Debug -B./build &&^
cd build &&^
cmake --build . &&^
